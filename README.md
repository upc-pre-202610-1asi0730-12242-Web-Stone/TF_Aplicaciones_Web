...
<strong>Entrevista 2: Gianmarco Correa</strong>

Captura:  
 
<img src="./entrevista_guianmarco.png" alt="Entrevista Gianmarco" width="220"/>
...
Gianmarco Correa, de 35 años, es médico y ha visitado recientemente el Museo de Arte de Lima (MALI). Durante la entrevista, menciona que en el contexto peruano no existe una cultura muy fuerte de посеща frecuente a museos, lo que se refleja en la baja afluencia de visitantes en muchos de estos espacios.

Desde su experiencia, considera que uno de los principales problemas es la limitada información disponible dentro de las salas. En varias ocasiones, percibe que las descripciones no son suficientes para comprender completamente las obras, lo que reduce el interés del visitante promedio.

En cuanto al uso de tecnología, Gianmarco está familiarizado con herramientas digitales en su vida diaria y utiliza principalmente su celular para acceder a información. Señala que una solución sencilla, como el uso de códigos QR, podría ser una forma efectiva de mejorar la experiencia sin complicar al usuario.

Respecto a sus expectativas, valora la idea de poder acceder a contenido claro y directo desde su dispositivo móvil, especialmente si esto le permite entender mejor el contexto de las obras. Considera que este tipo de implementación no solo enriquecería la visita, sino que también podría incentivar a más personas a interesarse por los museos.
