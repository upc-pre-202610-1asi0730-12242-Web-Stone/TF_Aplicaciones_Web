...
### Commits durante junio 11 - junio 18, 2026

![Pulse Graph AV2](../../assets/img/5_2_3_3-sprint-backlog-3/Pulse%20Graph%20AV2.png)
_Durante la semana del 11 al 18 de junio de 2026, 4 autores realizaron 4 commits a main y 16 commits a todas las ramas. Se modificaron 42 archivos con 1031 adiciones y 535 eliminaciones, evidenciando la implementación del backend y las correcciones de frontend._

### Gráfico de Red y Colaboración

![Network Graph AV2](../../assets/img/5_2_3_3-sprint-backlog-3/Network%20Graph%20AV2.png)

_El Network Graph muestra las ramas de trabajo del Sprint 3: `feature/get-artifact-by-qr`, `feature/get-recommendations-operations` y `feature/manage-favorites`, confluyendo hacia `develop` y posteriormente a `main`. Esto evidencia el flujo GitFlow aplicado con un branch por endpoint._

### Gráfico de Contribuidores — Backend (khiputech-platform)

![Contributors AV2](../../assets/img/5_2_3_3-sprint-backlog-3/foto-12-github-contributors.png)

_Contribuciones al repositorio `khiputech-platform` durante el periodo mayo 25 – junio 18, 2026._

| Integrante        | GitHub Username    | Commits | Líneas Añadidas | Líneas Eliminadas | Bounded Context / Responsabilidad         |
| ----------------- | ------------------ | ------- | --------------- | ----------------- | ----------------------------------------- |
| Luis Huaco        | perghormaru-pixel  | 17      | +5150           | -1280             | Maintenance (MAI), BD, Release            |
| Oscar Checa       | OscarCheca         | 3       | +180            | -0                | Analytics (ANA), actualización frontend   |
| Andrea Correa     | Daiko-07           | 2       | +69             | -2                | Visiting (VIS)                            |
| Fabian Sandoval   | JFabianSandoval    | 2       | +86             | -0                | Operation (OPE), Team Leader              |
| Winnie Merino     | winniemerino       | 1       | +10             | -0                | Capacity (CAP)                            |

**Total backend:** 25 commits | +5495 líneas añadidas | -1282 líneas eliminadas

### Resumen de actividad semanal (Pulse — junio 11 al 18)

| Métrica                        | Valor                        |
| ------------------------------ | ---------------------------- |
| Autores activos                | 4                            |
| Commits a main                 | 4                            |
| Commits a todas las ramas      | 16                           |
| Archivos modificados           | 42                           |
| Líneas añadidas                | +1031                        |
| Líneas eliminadas              | -535                         |
| Pull requests activos          | 0                            |
| Issues cerrados                | 0                            |
### Registro de Versiones del Informe
...
<table style="width: 100%; border-collapse: collapse;">
  <!-- BARRA DE ARRIBA -->
    ...
    <td style="text-align: center;">- Avance del Capitulo I<br></td>
    </tr>
    <tr>
    <td style="text-align: center;">0.0.1</td>
    <td style="text-align: center;">11/04/2026</td>
    ...
    <td style="text-align: center;">- Avance del Capitulo III<br></td>
    </tr>
    <tr>
    <td style="text-align: center;">0.0.1</td>
    <td style="text-align: center;">11/04/2026</td>
    ...
    <td style="text-align: center;">11/04/2026</td>
    <td style="text-align: center;">Oscar Checa</td>
    <td style="text-align: center;">- Entrevista 1<br></td>
    </tr>
    <tr>
    <td style="text-align: center;">0.0.2</td>
    <td style="text-align: center;">11/04/2026</td>
    <td style="text-align: center;">Winnie Merino</td>
    <td style="text-align: center;">- Entrevista 2<br></td>
    </tr>
    <tr>
    <td style="text-align: center;">0.0.2</td>
    <td style="text-align: center;">11/04/2026</td>
    <td style="text-align: center;">Luis Huaco</td>
    <td style="text-align: center;">- Correcion del Capitulo III<br></td>
    </tr>
    <tr>
    <td style="text-align: center;">0.0.2</td>
    <td style="text-align: center;">11/04/2026</td>
    ...
    <td style="text-align: center;">11/04/2026</td>
    <td style="text-align: center;">Winnie Merino</td>
    <td style="text-align: center;">- Entrevista 4<br></td>
    </tr>
    <tr>
    <td style="text-align: center;">0.0.2</td>
    <td style="text-align: center;">11/04/2026</td>
    <td style="text-align: center;">Winnie Merino</td>
    <td style="text-align: center;">- Entrevista 5<br></td>
    </tr>
    <tr>
    <td style="text-align: center;">0.0.2</td>
    <td style="text-align: center;">11/04/2026</td>
    <td style="text-align: center;">Winnie Merino</td>
    <td style="text-align: center;">- Entrevista 6<br></td>
    </tr>
    <tr>
    ...
    <td style="text-align: center;">11/04/2026</td>
    <td style="text-align: center;">Oscar Checa</td>
    <td style="text-align: center;">- Agregación del Capitulo III<br></td>
    </tr>
    <tr>
    <td style="text-align: center;">0.0.3</td>
    <td style="text-align: center;">11/04/2026</td>
    ...
    <div class="container">
        ...
        <div class="persona">
            ...
            <div class="tb1">
                ...
                Lideró la definición de la arquitectura DDD y los bounded contexts del sistema. Coordinó el Sprint Planning 2 y distribuyó responsabilidades del frontend entre el equipo.
            </div>
            <div class="av2">
                <span class="label">AV2 :</span> 
                Lideró el Bounded Context Operation (OPE) implementando el endpoint GET /recommendations/operations con arquitectura DDD completa. Coordinó el Sprint 3 como Scrum Master, asignando un bounded context a cada integrante y asegurando el cumplimiento del Sprint Goal.
            </div>
        </div>
        <!-- Oscar -->
        <div class="persona">
            <div class="nombre">Oscar Checa</div>
            <div class="av1">
                <span class="label">AV1 :</span> 
            ...
            <div class="tb1">
                <span class="label">TB1 :</span> 
                Lideró la implementación de la primera versión del frontend Web Application. Facilitó la revisión de mockups y flujos de usuario con el equipo.
            </div>
            <div class="av2">
                <span class="label">AV2 :</span> 
                Lideró el Bounded Context Analytics (ANA) implementando el endpoint GET /dashboard/metrics. Además coordinó las correcciones del frontend para asegurar compatibilidad con los nuevos endpoints del backend.
            </div>
        </div>
        <!-- Andrea -->
        <div class="persona">
            <div class="nombre">Andrea Correa</div>
            <div class="av1">
                <span class="label">AV1 :</span> 
            ...
            <div class="tb1">
                <span class="label">TB1 :</span> 
                Lideró la actualización del Capítulo II con el análisis de entrevistas del segundo segmento objetivo. Coordinó la revisión cruzada de los artefactos de needfinding.
            </div>
            <div class="av2">
                <span class="label">AV2 :</span> 
                Lideró el Bounded Context Visiting (VIS) implementando el endpoint GET /artifacts/{qr_id} con modelo Artwork bajo arquitectura DDD. Tomó decisiones de diseño sobre la estructura de respuesta JSON para compatibilidad con el frontend SPA.
            </div>
        </div>
        <!-- Winnie -->
        <div class="persona">
            <div class="nombre">Winnie Merino</div>
            <div class="av1">
                <span class="label">AV1 :</span> 
            ...
            <div class="tb1">
                <span class="label">TB1 :</span> 
                Lideró la actualización de wireframes y User Flow Diagrams del Capítulo IV. Propuso mejoras en la navegación del dashboard que fueron adoptadas por el equipo.
            </div>
            <div class="av2">
                <span class="label">AV2 :</span> 
                Lideró el Bounded Context Capacity (CAP) implementando endpoints de control de aforo y lógica de alertas por sala. Tomó decisiones sobre los umbrales de disparo de alertas y la estructura del modelo RoomCapacity.
            </div>
        </div>
        <!-- Luis -->
        <div class="persona">
            <div class="nombre">Luis Huaco</div>
            <div class="av1">
                <span class="label">AV1 :</span> 
            ...
            <div class="tb1">
                <span class="label">TB1 :</span> 
                Lideró la actualización del Product Backlog y la documentación técnica del Capítulo III. Coordinó la corrección del Registro de Versiones del informe.
            </div>
            <div class="av2">
                <span class="label">AV2 :</span> 
                Lideró el Bounded Context Maintenance (MAI) implementando el endpoint POST /maintenance con lógica de bloqueo automático de QR. Además lideró la actualización de la base de datos con las migraciones EF Core y ejecutó el release oficial del proyecto backend.
            </div>
        </div>
    </div>
    </td>
    <td>
    <div style="text-align: justify">El liderazgo conjunto permitió aprovechar las fortalezas individuales sin crear dependencias críticas en una sola persona. La rotación de roles de facilitador en reuniones incrementó el sentido de ownership del proyecto en cada integrante. Se evidenció que las decisiones técnicas tomadas colaborativamente (como la elección de DDD y la arquitectura de microservicios) tuvieron mayor adherencia durante la implementación porque todos participaron en su definición. En el AV2, la asignación de un bounded context por integrante demostró que el liderazgo distribuido escala efectivamente: cada miembro tomó decisiones autónomas de diseño dentro de su dominio mientras mantenía coherencia con la arquitectura global acordada en equipo.</div>
    </td>
  </tr>
  <!-- Fila 7 -->
  <tr>
...
<div class="container">
    ...
    <div class="persona">
        ...
        <div class="tb1">
            <span class="label">TB1 :</span> 
            Capítulo V - Sprint Planning 2, Sprint Backlog 2 y correcciones generales del informe. Estableció el Sprint Goal del Sprint 2 con el equipo.
        </div>
        <div class="av2">
            <span class="label">AV2 :</span> 
            Capítulo V - Sprint Planning 3, Aspect Leaders and Collaborators, Sprint Backlog 3, Development Evidence y Services Documentation Evidence. Estableció el Sprint Goal del Sprint 3 siguiendo el formato Scrum.org y planificó las tareas del equipo mediante Jira.
        </div>
    </div>
    <!-- Oscar -->
    <div class="persona">
        ...
        <div class="tb1">
            <span class="label">TB1 :</span> 
            Capítulo IV actualizado - Wireflows y User Flow Diagrams corregidos. Primera versión del frontend desplegada con componentes Vue consistentes con el Design System.
        </div>
        <div class="av2">
            <span class="label">AV2 :</span> 
            Implementación del Bounded Context Analytics (ANA) con endpoint GET /dashboard/metrics. Actualización del frontend para consumir los nuevos endpoints del backend, asegurando la integración entre la Web Application y el RESTful API.
        </div>
    </div>
    <!-- Winnie -->
    <div class="persona">
        ...
        <div class="tb1">
            <span class="label">TB1 :</span> 
            Capítulo IV actualizado - Wireframes y mockups mejorados. Implementó nuevas vistas del frontend siguiendo el flujo de navegación definido.
        </div>
        <div class="av2">
            <span class="label">AV2 :</span> 
            Implementación del Bounded Context Capacity (CAP) con endpoints GET /rooms/capacity y lógica de alertas por exceso de aforo. Documentación de los endpoints en Swagger con criterios de aceptación verificables.
        </div>
    </div>
    <!-- Todos (equipo) -->
    <div class="persona">
        ...
        <div class="tb1">
            <span class="label">TB1 :</span> 
            Participación en el Sprint Planning 2, Daily Scrums y Sprint Review. Todos contribuyeron con commits al repositorio del informe y al repositorio del frontend.
        </div>
        <div class="av2">
            <span class="label">AV2 :</span> 
            Participación en el Sprint Planning 3 via Google Meet. Cada integrante creó su feature branch, implementó su bounded context y realizó commits con conventional commits. El equipo completó los 5 bounded contexts del backend en una sola semana de Sprint.
        </div>
    </div>
    <!-- Luis -->
    <div class="persona">
        ...
        <div class="tb1">
            <span class="label">TB1 :</span> 
            Capítulo III actualizado - Product Backlog refinado con 52 User Stories priorizadas. Correcciones del Registro de Versiones del informe.
        </div>
        <div class="av2">
            <span class="label">AV2 :</span> 
            Implementación del Bounded Context Maintenance (MAI) con endpoint POST /maintenance y lógica de bloqueo QR. Actualización de la base de datos con migraciones EF Core para todas las tablas del sistema. Ejecución del release oficial del proyecto khiputech-platform.
        </div>
    </div>
    <!-- Andrea -->
    <div class="persona">
        ...
        <div class="tb1">
            <span class="label">TB1 :</span> 
            Capítulo II actualizado - Análisis de entrevistas del segundo segmento objetivo. Actualización del Event Storming con nuevos bounded contexts identificados.
        </div>
        <div class="av2">
            <span class="label">AV2 :</span> 
            Implementación del Bounded Context Visiting (VIS) con endpoint GET /artifacts/{qr_id} bajo arquitectura DDD. Agregó las User Stories US-MAI-A a US-MAI-G al Capítulo III (Specification) para documentar el bounded context Maintenance.
        </div>
    </div>
    ...
    <div class="persona">
        ...
        <div class="tb1">
            <span class="label">TB1 :</span> 
            Cada integrante trabajó en su rama feature y realizó merge a develop al completar su tarea, manteniendo el historial limpio del repositorio.
        </div>
        <div class="av2">
            <span class="label">AV2 :</span> 
            Se aplicó GitFlow con un branch por endpoint (feature/get-recommendations-operations, feature/get-artifact-by-qr, feature/get-rooms-capacity, etc.). 25 commits al repositorio backend con conventional commits evidencian el trabajo distribuido del equipo.
        </div>
    </div>
    <!-- Revisiones cruzadas -->
    <div class="persona">
        ...
        <div class="tb1">
            <span class="label">TB1 :</span> 
            Los endpoints del frontend fueron revisados por al menos un integrante distinto al implementador antes de hacer merge a develop.
        </div>
        <div class="av2">
            <span class="label">AV2 :</span> 
            Cada bounded context fue revisado en el Sprint Review por el Team Leader antes de ser mergeado a develop. La documentación Swagger de cada endpoint fue validada por Luis Huaco como parte del proceso de release.
        </div>
    </div>
</div>
    </td>
    <td>
    <div style="text-align: justify">El entorno colaborativo se materializó en la consistencia entre capítulos: las User Stories del Cap. III reflejan los segmentos objetivo del Cap. I, los wireframes del Cap. IV implementan los requisitos del Cap. II, y la arquitectura del Cap. V responde a las especificaciones del Cap. III. La planificación por capítulos permitió avances paralelos: mientras Oscar diseñaba mockups (Cap. IV), Andrea documentaba competidores (Cap. II) y Luis especificaba el Product Backlog (Cap. III). Se cumplió el 100% de los entregables AV2: primera versión del backend RESTful desplegada con 5 bounded contexts implementados bajo arquitectura DDD, endpoints documentados en Swagger, frontend y landing page actualizados, y 59 User Stories documentadas en el informe. La asignación de un bounded context por integrante demostró que el modelo de trabajo distribuido escala correctamente cuando las metas están claramente definidas y las responsabilidades son explícitas desde el Sprint Planning.</div>
    </td>
  </tr>
</table>
...
|  W/H  | Pregunta | Respuesta |
| :---: | :--- | :--- |
| **What (Qué)** | ¿Cuál es el problema? | La invisibilidad de los datos de comportamiento del visitante tras cruzar la taquilla. Los museos operan "a ciegas" dentro de sus propias salas, desconociendo qué piezas generan interés y cuáles pasan desapercibidas, sumado a una oferta informativa estática que no conecta con el público digital. |
...
| **When (Cuándo)** | ¿Cuándo sucede el problema? | El problema de datos es constante, pero la crisis de gestión ocurre en las "horas pico" o durante exhibiciones temporales, donde la falta de métricas impide redistribuir al personal de seguridad o guías para evitar cuellos de botella. |
...
| **Where (Dónde)** | ¿Dónde está el cliente cuando usa el producto? | El visitante se encuentra frente a las piezas de arte o circulando por los pasillos del museo. El administrador puede estar en la oficina técnica del museo o monitoreando de forma remota desde cualquier dispositivo con acceso a la red. |
...
| **Who (Quién)** | ¿Quiénes están involucrados? | Directores de museos, curadores de arte, personal de seguridad, encargados de marketing cultural y el público visitante (turistas y estudiantes). |
...
| **Why (Por qué)** | ¿Cuál es la causa del problema? | El alto costo de las soluciones tecnológicas tradicionales (cámaras con IA costosas) y la falta de infraestructura digital integrada que combine hardware de conteo con entrega de contenido en una sola plataforma económica. |
| **How (Cómo)** | ¿En qué condiciones los clientes usan nuestro producto? | En un entorno de iluminación controlada (típico de museos) donde los sensores infrarrojos son altamente efectivos y donde se requiere un acceso rápido a la información sin necesidad de descargar aplicaciones pesadas (Web-based). |
...
| **How much (Cuánto)** | Costo para el cliente | Se plantea un modelo de implementación económica (pago único por hardware) + una suscripción mensual mínima (SaaS) por el mantenimiento del subdominio y el acceso al dashboard de datos. |
...
- Brown, S. (2018). _Software Architecture for Developers_. Leanpub.
- Richardson, C. (2018). _Microservices Patterns: With examples in Java_. Manning Publications.
  **Internet of Things (IoT):**
- Patel, K. K., & Patel, S. M. (2016). Internet of Things-IOT: Definition, Characteristics, Architecture, Enabling Technologies, Application & Future Challenges. _International Journal of Engineering Science and Computing_, 6(5).
  **Gamification:**
- Deterding, S., Dixon, D., Khaled, R., & Nacke, L. (2011). From game design elements to gamefulness: defining "gamification". _Proceedings of the 15th International Academic MindTrek Conference_, 9-15.
...
- React Documentation. (2024). _React – A JavaScript library for building user interfaces_. Recuperado de https://react.dev/
- PostgreSQL Documentation. (2024). _PostgreSQL: The World's Most Advanced Open Source Relational Database_. Recuperado de https://www.postgresql.org/docs/
- MQTT.org. (2024). _MQTT: The Standard for IoT Messaging_. Recuperado de https://mqtt.org/
  **Diseño y UX:**
- Nielsen Norman Group. (2024). _Evidence-Based User Experience Research, Training, and Consulting_. Recuperado de https://www.nngroup.com/
- Material Design. (2024). _Material Design Guidelines_. Recuperado de https://material.io/design
  **Analítica y Museos:**
- ICOM – International Council of Museums. (2024). Recuperado de https://icom.museum/
- American Alliance of Museums. (2024). _Digital Transformation in Museums_. Recuperado de https://www.aam-us.org/

---

### Normas y Estándares

- ISO/IEC 25010:2011. _Systems and software engineering — Systems and software Quality Requirements and Evaluation (SQuaRE)_
- WCAG 2.1. _Web Content Accessibility Guidelines_. W3C. Recuperado de https://www.w3.org/WAI/WCAG21/quickref/
...
- Visual Studio Code. (2024). _Code Editing. Redefined_. Microsoft. https://code.visualstudio.com/
- Git. (2024). _Git - Distributed version control system_. https://git-scm.com/
- GitHub. (2024). _Where the world builds software_. https://github.com/
  **Diseño:**
- Figma. (2024). _Collaborative Interface Design Tool_. https://www.figma.com/
- Miro. (2024). _The Visual Workspace for Innovation_. https://miro.com/
  **Documentación:**
- Pandoc. (2024). _A universal document converter_. https://pandoc.org/
