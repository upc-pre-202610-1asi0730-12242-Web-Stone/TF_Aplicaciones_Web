...
| :----------: | :------: | :----: |:-------------------------------------------------------:| :--: |
| Gianmarco Jair Correa | 8:00m | 0:10m | ![Evidencia_Entrevista](../assets/img/interviews/interview_guianmarco.jpeg) | [Click Aqui](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20231e504_upc_edu_pe/IQAmCXrnLqkgS73XjqgKV50vAWEm3DMw925zTRx9BXdNV18?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=ljtZBd#) |

Resumen:

Gianmarco Jair Correa, un médico de 35 años que reside cerca de Julio Cesar Tello, comentó que suele visitar museos ocasionalmente como forma de relajación y aprendizaje cultural. El último museo que visitó fue el MALI (Museo de Arte de Lima), donde disfrutó de la experiencia visual, aunque mencionó que muchas veces la información disponible junto a las obras resulta insuficiente para comprender completamente su contexto, significado o importancia histórica.

Gestión y Desafíos: Actualmente, considera que la experiencia dentro de los museos puede quedarse corta en cuanto a información interactiva, ya que la mayoría de obras solo cuentan con pequeñas descripciones o leyendas básicas. Esto provoca que algunas piezas interesantes no logren transmitir toda la idea o historia detrás de ellas. Por ello, le parecería útil implementar una solución digital mediante códigos QR que permita ampliar la información de manera rápida y accesible durante el recorrido. Además, comentó que, en su experiencia, nunca se ha sentido aglomerado dentro de los museos, ya que considera que en el Perú no existe una costumbre muy marcada de visitar estos espacios culturales. Debido a ello, percibe que la mayoría de museos suelen estar poco concurridos durante gran parte del día.

Tecnología y Habilidades: En su rutina diaria utiliza principalmente su teléfono celular debido a la naturaleza demandante de su trabajo como médico. Las aplicaciones que más utiliza son WhatsApp, Instagram, TikTok y plataformas de búsqueda rápida de información. No suele usar demasiado la laptop salvo en situaciones necesarias, ya que la mayor parte de sus actividades las realiza desde el móvil.

Expectativas y Necesidades: Gianmarco considera que una herramienta digital dentro del museo podría mejorar considerablemente la experiencia de los visitantes. Le gustaría que, al escanear un código QR, se pueda acceder fácilmente a contenido adicional como contexto histórico, curiosidades, imágenes complementarias, contenido multimedia e información más detallada de cada obra. Además, valora que el acceso sea rápido, intuitivo y sin necesidad de descargar aplicaciones adicionales. Sus respuestas reflejan una personalidad curiosa, práctica y abierta al uso de tecnología que facilite el aprendizaje y haga la experiencia cultural más completa, dinámica e interesante.
